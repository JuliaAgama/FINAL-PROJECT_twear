...
import { showPersonalCabinetMenuAction, hidePersonalCabinetMenuAction } from "../../../store/actions/header";
...
export default () => {
    ...
    const isVisible = useSelector(state => state.header.showPersonalCabinetMenu);
    ...
    const clickHandler = () => {
        ...
        if (customer.firstName) {
            if (isVisible) {
                ...
                dispatch(showPersonalCabinetMenuAction())
            }
        } else {
