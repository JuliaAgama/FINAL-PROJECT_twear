...
exports.searchProducts = async (req, res, next) => {
  ...
  exports.matchProductsByObject = async (req, res, next) => {
    try {
      ...
      // const productsMatchSize = await Product.find({"colors.sizes": {$elemMatch: req.body}}); // check with Saribeg how it can work
      const productsMatchSize = await Product.find({colors: {$elemMatch: {sizes: {$elemMatch: req.body}}}}); // check with Saribeg how it can work
